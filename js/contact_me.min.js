        ...
        "#contactForm input,#contactForm textarea").jqBootstrapValidation({
            ...
            submitSuccess: function (t, e) {
                ...
                var s = $("input#name").val(),
                    ...
                    i = s; 0 <= i.indexOf(" ") && (i = s.split(" ").slice(0, -1).join(" ")),
                        ...
                        $.ajax({
                            ...
                            error: function () {
                                $("#success").html("<div class='alert alert-danger'>"),
                                    ...
                                    $("#success > .alert-danger").append($("<strong>").text("Sorry " + i + ", it seems that my mail server is not responding. Please try again later!")), $("#success > .alert-danger").append("</div>"),
                                    $("#contactForm").trigger("reset")
                            },
                            complete: function () {
                                setTimeout(function () {
